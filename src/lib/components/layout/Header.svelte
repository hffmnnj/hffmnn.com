	...
	<div class="max-w-6xl mx-auto px-6">
		...
		<div class="flex items-center justify-between py-2 border-t border-rule">
			...
			<nav class="hidden md:flex items-center gap-6 text-sm">
				...
				>
				<span class="relative -top-[2px]"><HugeiconsIcon icon={Home01Icon} size={14} strokeWidth={1.5} /></span>
				Home
				</a>
				<a
					href="/tools"
				...
				>
					<span class="relative -top-[2px]"><HugeiconsIcon icon={CodeIcon} size={14} strokeWidth={1.5} /></span>
					Tools
				</a>
				<a
					href="/venture"
				...
				>
					<span class="relative -top-[2px]"><HugeiconsIcon icon={HeartCheckIcon} size={14} strokeWidth={1.5} /></span>
					Pulsyn
				</a>
			</nav>
